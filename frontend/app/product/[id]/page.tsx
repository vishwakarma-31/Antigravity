...
export default function ProductPage() {
  ...
  useEffect(() => {
    ...
    tl.fromTo(imageRef.current, { opacity: 0, x: -50 }, { opacity: 1, x: 0, duration: 0.8 })
      .fromTo(detailsRef.current, { opacity: 0, x: 50 }, { opacity: 1, x: 0, duration: 0.8 }, "-=0.6");
  }, [product]);
